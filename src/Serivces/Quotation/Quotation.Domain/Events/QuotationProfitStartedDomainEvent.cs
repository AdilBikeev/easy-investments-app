namespace Quotation.Domain.Events
{
    /// <summary>
    /// Событие используется во время создание/обновления данных в таблие QuotationProfit.
    /// </summary>
    public class QuotationProfitStartedDomainEvent : INotification
    {
        /// <summary>
        ...
        /// </summary>
        public int CountBuyQuotationPossible { get; }
        ...
        public QuotationProfitStartedDomainEvent(
            string fullName,
            string figi,
            string ticker,
