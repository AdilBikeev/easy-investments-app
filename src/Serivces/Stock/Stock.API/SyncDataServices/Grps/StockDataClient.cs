...
namespace Stock.API.SyncDataServices.Grps
{
    ...
    public interface IStockDataClient
    {
        ...
        public Task<StockProfitReadDTO> GetProfitByFigi(string figiId, decimal investedAmount, string currencyFrom, DateTime dateFrom, DateTime dateTo);
    }
    ...
    public class StockDataClient : IStockDataClient
    {
        ...
        ///<inheritdoc/>
        public async Task<StockProfitReadDTO> GetProfitByFigi(string figiId, decimal investedAmount, string currencyFrom, DateTime dateFrom, DateTime dateTo)
        {
